...
public:
  ...
  explicit constexpr LoginRequest_TestEntry_DoNotUse(
...
class GetFriendListsResponse final :
 ...
 public:
  ...
  enum : int {
    kFiendListFieldNumber = 2,
    kResultFieldNumber = 1,
  };
  // repeated .fixbug.User fiend_list = 2;
  int fiend_list_size() const;
  private:
  int _internal_fiend_list_size() const;
  public:
  void clear_fiend_list();
  ::fixbug::User* mutable_fiend_list(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
      mutable_fiend_list();
  private:
  const ::fixbug::User& _internal_fiend_list(int index) const;
  ::fixbug::User* _internal_add_fiend_list();
  public:
  const ::fixbug::User& fiend_list(int index) const;
  ::fixbug::User* add_fiend_list();
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User > fiend_list_;
  ::fixbug::ResultCode* result_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_test_2eproto;
};
...
// repeated .fixbug.User fiend_list = 2;
inline int GetFriendListsResponse::_internal_fiend_list_size() const {
  return fiend_list_.size();
}
inline int GetFriendListsResponse::fiend_list_size() const {
  return _internal_fiend_list_size();
}
inline void GetFriendListsResponse::clear_fiend_list() {
  fiend_list_.Clear();
}
inline ::fixbug::User* GetFriendListsResponse::mutable_fiend_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResponse.fiend_list)
  return fiend_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendListsResponse::mutable_fiend_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListsResponse.fiend_list)
  return &fiend_list_;
}
inline const ::fixbug::User& GetFriendListsResponse::_internal_fiend_list(int index) const {
  return fiend_list_.Get(index);
}
inline const ::fixbug::User& GetFriendListsResponse::fiend_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponse.fiend_list)
  return _internal_fiend_list(index);
}
inline ::fixbug::User* GetFriendListsResponse::_internal_add_fiend_list() {
  return fiend_list_.Add();
}
inline ::fixbug::User* GetFriendListsResponse::add_fiend_list() {
  ::fixbug::User* _add = _internal_add_fiend_list();
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsResponse.fiend_list)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListsResponse::fiend_list() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListsResponse.fiend_list)
  return fiend_list_;
}
