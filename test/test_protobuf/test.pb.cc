...
constexpr LoginRequest_TestEntry_DoNotUse::LoginRequest_TestEntry_DoNotUse(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized){}
struct LoginRequest_TestEntry_DoNotUseDefaultTypeInternal {
  constexpr LoginRequest_TestEntry_DoNotUseDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT LoginRequest_TestEntry_DoNotUseDefaultTypeInternal _LoginRequest_TestEntry_DoNotUse_default_instance_;
...
const uint32_t TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsResponse, fiend_list_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::fixbug::ResultCode)},
  { 8, 16, -1, sizeof(::fixbug::LoginRequest_TestEntry_DoNotUse)},
  { 18, -1, -1, sizeof(::fixbug::LoginRequest)},
  { 27, -1, -1, sizeof(::fixbug::LoginResponse)},
  { 35, -1, -1, sizeof(::fixbug::GetFriendListsRequest)},
  { 42, -1, -1, sizeof(::fixbug::User)},
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test_2eproto = {
  false, false, 669, descriptor_table_protodef_test_2eproto, "test.proto", 
...
void LoginRequest::ArenaDtor(void* object) {
  ...
  (void)_this;
  _this->test_. ~MapField();
}
inline void LoginRequest::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena) {
  if (arena != nullptr) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_fiend_list(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
uint8_t* GetFriendListsResponse::_InternalSerialize(
  ...
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_fiend_list_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(2, this->_internal_fiend_list(i), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendListsResponse)
  ...
  // repeated .fixbug.User fiend_list = 2;
  total_size += 1UL * this->_internal_fiend_list_size();
  for (const auto& msg : this->fiend_list_) {
    total_size +=
...
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendListsResponse)
  ...
  fiend_list_.MergeFrom(from.fiend_list_);
  if (from._internal_has_result()) {
    _internal_mutable_result()->::fixbug::ResultCode::MergeFrom(from._internal_result());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
...
void GetFriendListsResponse::InternalSwap(GetFriendListsResponse* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  fiend_list_.InternalSwap(&other->fiend_list_);
